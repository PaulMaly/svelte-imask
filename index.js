(function (global, factory) {
  ...
  */
  ...
  /* src/MaskedInput.svelte generated by Svelte v3.16.0 */

  function create_fragment(ctx) {
  	let input;
  	let imask_action;
  	let dispose;
  	let input_levels = [/*attrs*/ ctx[1]];
  	let input_data = {};
  	...
  	return {
  		c() {
  			...
  			dispose = [
  				listen(input, "click", /*click_handler*/ ctx[5]),
  				listen(input, "keydown", /*keydown_handler*/ ctx[6]),
  				listen(input, "input", /*input_handler*/ ctx[7]),
  				listen(input, "change", /*change_handler*/ ctx[8]),
  				listen(input, "search", /*search_handler*/ ctx[9]),
  				listen(input, "focus", /*focus_handler*/ ctx[10]),
  				listen(input, "blur", /*blur_handler*/ ctx[11]),
  				listen(input, "invalid", /*invalid_handler*/ ctx[12]),
  				listen(input, "accept", /*accept*/ ctx[2]),
  				listen(input, "accept", /*accept_handler*/ ctx[13]),
  				listen(input, "complete", /*complete_handler*/ ctx[14])
  			];
  		},
  		m(target, anchor) {
  			insert(target, input, anchor);
  			imask_action = imask.call(null, input, /*options*/ ctx[0]) || ({});
  		},
  		p(ctx, [dirty]) {
  			set_attributes(input, get_spread_update(input_levels, [dirty & /*attrs*/ 2 && /*attrs*/ ctx[1]]));
  			if (is_function(imask_action.update) && dirty & /*options*/ 1) imask_action.update.call(null, /*options*/ ctx[0]);
  		},
  		i: noop,
  		o: noop,
  		d(detaching) {
  			if (detaching) detach(input);
  			if (imask_action && is_function(imask_action.destroy)) imask_action.destroy();
  			run_all(dispose);
  		}
  	};
  }
  ...
  function instance($$self, $$props, $$invalidate) {
  	...
  	function accept({ detail: imask }) {
  		$$invalidate(3, value = imask.unmaskedValue);
  	...
  	$$self.$$.update = () => {
  		 $$invalidate(0, { options, ...attrs } = $$props, options, ($$invalidate(1, attrs), $$invalidate(4, $$props)));
  	};
