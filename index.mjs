...
/* src/MaskedInput.svelte generated by Svelte v3.12.1 */
...
function create_fragment(ctx) {
	...
	return {
		...
		m(target, anchor) {
			...
			mask_action = mask.call(null, input, ctx.opts) || {};
		},
		...
		p(changed, ctx) {
			...
			if (typeof mask_action.update === 'function' && changed.opts) {
				mask_action.update.call(null, ctx.opts);
			}
		},
		...
		d(detaching) {
			...
			if (mask_action && typeof mask_action.destroy === 'function') mask_action.destroy();
			run_all(dispose);
		}
	};
}
...
export { MaskedInput, mask as imask };
